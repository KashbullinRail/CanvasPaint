...
enum class TOOLS(
    ...
    NORMAL(R.drawable.ic_launcher_background),
    DASH(R.drawable.ic_launcher_background),
    SIZE(R.drawable.ic_launcher_background),
    PALETTE(R.drawable.ic_launcher_background)
}